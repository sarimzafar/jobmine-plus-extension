      ...
      case 9:
         ...
         if (pageStatus[1]*1 > 1) {
            ...
            if(currentRange[currentRange.length-1] != pageStatus[1]) {     
               ...
               this.controls = first+leftButton+"</a>"+pageStatus.join(" of ")+rightButton+last;
            }
         }
         break;
      case 5:
 ...
 *    Deletes a column
 */
JbmnplsTable.prototype.deleteRow = function(index) {
   if (this.empty() || index == null) {
      return false;
   }
...
/**
 *    Deletes a range of row
 *       Option 1: table.deleteRowRange([0,1,3,5]);   <--- deletes these rows
 *       Option 2: table.deleteRowRange(0, 4);        <--- deletes rows from 0->4
 */
JbmnplsTable.prototype.deleteRowRange = function(startIndex_deleteArr, endIndex) {
   if (this.empty() || startIndex_deleteArr == null || endIndex == null) {
      return false;
   }
   if ($.isArray(startIndex_deleteArr)) { //If one input: array of indexes
...
JbmnplsTable.prototype.build = function() {
   ...
   html +=     "<a class='options' href='#'>Customize</a> | <a class='options' href='#'>Export</a></div>";
   html +=     "</div></div>";
   this.html = html;
   html = null;
   return this.html;
...
var CSSOBJ = {
   ...
   "div.jbmnplsTable div.jbmnplsTableControls a:hover" : {
      "color" : "white",
   },
   /**
    *    Table column hiding
