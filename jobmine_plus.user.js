...
\*======================================*/
   ...
   //Sorts and corrects date sorting for Jobmine columns
   $.tablesorter.addParser({ 
      id: 'jobmineDates',     //Use this id for table sorting
      is: function(s) { 
         return false; 
      }, 
      format: function(s) { 
 ...
 */
   ...
   //If we are on the normal login page
      ...
      //Add a checkbox to save user ID and add an eventlistener
