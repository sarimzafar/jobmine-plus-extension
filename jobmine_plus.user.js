...
function showPopup(isBlack, body, title, width, height, onCloseFunction){
   ...
   if (isBlack) {
      ...
      $("#jbmnplsPopupContent").removeClass("disabled");
   } else {
      $("#jbmnplsPopupContent").addClass("disabled");
   }
...
var CSSOBJ = {
   ...
   "#jbmnplsPopup[name='customize'].black #jbmnplsPopupBody div.customizeEntry.instructions" : {
      "text-align"      :  "center",
      "background"      :  "#CCC",
   },
